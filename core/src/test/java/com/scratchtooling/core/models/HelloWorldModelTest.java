 ...
 */
package com.scratchtooling.core.models;
...
import com.scratchtooling.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "scratch-tooling/components/helloworld");
